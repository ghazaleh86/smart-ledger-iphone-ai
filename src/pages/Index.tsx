...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-white pt-12 pb-6 px-6 shadow-sm border-b border-gray-100">
        <AccountSelector
          accounts={accounts}
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <div className="space-y-0">
                    ...
                    <div className="grid grid-cols-12 gap-4 items-center">
                      ...
                      <div className="col-span-2">
                        {transaction.category ? (
                          ...
                          <span className="text-sm text-gray-400 font-medium">Uncategorized</span>
                        )}
                      </div>
                      ...
                      <div className="col-span-2 text-right">
                        <span className={`font-bold text-lg ${transaction.type === 'income' ? 'text-green-600' : 'text-gray-900'}`}>
          ...
          <div className="md:hidden shadow-sm border border-gray-100 rounded-xl overflow-hidden bg-white">
          ...
          {isLoading && (
            <div className="text-center py-6">
              <div className="text-sm text-gray-500 font-medium">Loading more transactions...</div>
            </div>
          )}
          
          {displayedTransactions >= filteredTransactions.length && filteredTransactions.length > 0 && (
            <div className="text-center py-6">
              <div className="text-sm text-gray-500 font-medium">All transactions loaded</div>
            </div>
          )}
        </div>
      </div>
